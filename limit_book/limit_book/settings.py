"""
Django settings for limit_book project.
...
WSGI_APPLICATION = 'limit_book.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Limit Book API',
    'DESCRIPTION': 'API to work with Limit Book',
    'VERSION': '1.0.0',
